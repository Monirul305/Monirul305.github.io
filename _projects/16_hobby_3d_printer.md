...
**Outcome.** A functional desktop printer used continuously through my BUET years to fabricate the parts I needed for other projects — the 6-DOF arm's links and planetary gearboxes, drone airframe fittings, sensor enclosures, and so on. Roughly off-the-shelf for the electronics and motors; everything mechanical came out of the laser cutter from my own SolidWorks files.
