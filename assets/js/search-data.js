...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "cv",
          description: "R&amp;D Engineer &amp; Team Lead at Cybernetics Hi-Tech Solutions · B.Sc. EEE, BUET (CGPA 3.85 / 4.00, ranked 25 / 189, awarded with Honours) · production-deployed 3-robot AGV fleet, 6-DOF mobile manipulator, and EOD ROVs in UN peacekeeping service · two co-authored peer-reviewed papers (MDPI 2023, IEEE ICCIT 2024) plus first-author manuscript submitted on GA-tuned multi-rate cross-coupled BLDC synchronisation · seeking PhD positions for Spring or Fall 2027. Click the PDF icon (top right) for the printable version.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-jontro-soinik-v1-is-now-deployed-under-the-un-peacekeeping-mission-in-the-republic-of-mali-among-the-first-made-in-bangladesh-robotic-platforms-in-active-un-service",
          title: 'Jontro Soinik v1 is now deployed under the UN Peacekeeping Mission in the...',
          description: "",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-heavy-lift-multirotor-50-kg-drone-battery-optimizer",
          title: 'Heavy-Lift Multirotor (50 kg) + Drone Battery Optimizer',
          description: "Heavy-lift multirotor for logistics and emergency response — 50 kg payload, 30 min flight, 15 km comms, 1.5:1 T/W ratio. This page ships with an interactive in-browser Drone Battery Optimizer that sizes the pack and motor against your mission.",
          section: "Projects",handler: () => {
