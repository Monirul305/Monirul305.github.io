...
inter-MCU exchange, cutting inter-motor speed error by 41\,\% in clean-tracking
RMSE and by 65\,\% under a one-sided load against an independent-drive baseline (submitted); a co-authored fault-tolerant dual-network feedback scheme keeps a
