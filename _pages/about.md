...
The research direction I want to take into a PhD is **safe, decentralised coordination of mobile-robot teams in dense, human-occupied environments** — small teams of robots, some of them carrying manipulators, sharing a workspace with humans and with each other under no physical barriers, with coordination and safety properties that hold up under realistic sensor, network, and mechanical fault. I have built the layers this question touches: a production 3-robot AGV fleet running decentralised prioritised path planning for months in a live garment factory ([deployment]({{ '/projects/01_agv_fleet/' | relative_url }})); the embedded drive-and-comms substrate these field systems depend on, including first-author research on dual-MCU BLDC synchronisation for the EOD ROV drivetrain ([paper]({{ '/projects/04_ga_pid/' | relative_url }})); and a 6-DOF mobile manipulator with a from-scratch closed-form IK on Jontro Soinik 2.0, Cybernetics' lightweight, man-transportable next-generation EOD ROV — currently at bench / integration stage, not yet fielded ([manipulator]({{ '/projects/02_manipulator/' | relative_url }})). What I want to add in a PhD is the methodological rigor that field-deployed engineering rarely produces on its own: turning a coordination layer that empirically works into one with a *characterised* safety guarantee — scaled past demonstrative fleet sizes, and characterised down to the embedded substrate it relies on. The thesis direction, a concrete first-year plan, and how I would close the formal-methods gap are on the [research statement]({{ '/research-statement/' | relative_url }}) page.

I earned my **B.Sc. in Electrical and Electronic Engineering** from [BUET](https://www.buet.ac.bd) (CGPA 3.85 / 4.00, final year 3.98 / 4.00, ranked 25 of 189, awarded with Honours). I hold two peer-reviewed papers as a co-author ([MDPI Micromachines 2023](https://doi.org/10.3390/mi14071385), [IEEE ICCIT 2024](https://doi.org/10.1109/ICCIT64611.2024.11022430)) and three further manuscripts in flight — one first-author submitted on the BLDC synchronisation work above, one first-author in preparation on the AGV fleet, and one co-author submitted on dual-network feedback communication for a tele-operated multi-node vehicle. See the [publications]({{ '/publications/' | relative_url }}) page for author position and status on each.
